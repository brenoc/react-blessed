...
function ReactFSReconcileTransaction() {
...
Object.assign(
  ReactFSReconcileTransaction.prototype,
  Transaction.Mixin,
  ReactFSReconcileTransaction,
  Mixin
);

PooledClass.addPoolingTo(ReactFSReconcileTransaction);

export default ReactFSReconcileTransaction;
